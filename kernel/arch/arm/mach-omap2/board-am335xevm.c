...
#define AM335XEVM_WLAN_IRQ_GPIO               GPIO_TO_PIN(0, 23)
...
{
	pr_info("flc222 mmc0_init evm_id=%d",evm_id);
	switch (evm_id) {
	case BEAGLE_BONE_A3:
...
static struct evm_dev_cfg beaglebone_black_dev_cfg[] = {
	...
	//MMC0 要在mmc1_init等管脚初始化之前，因为MMC0会初始化后面的两个
	{mmc2_wl12xx_init,DEV_ON_BASEBOARD, PROFILE_NONE},
	{mmc0_init,	DEV_ON_BASEBOARD, PROFILE_NONE},  
	{i2c2_init,	DEV_ON_BASEBOARD, PROFILE_NONE},
	//uart1_ctsn.i2c2 和蓝牙的串口通讯口冲突了，需要关闭
